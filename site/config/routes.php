...
$route['^dk/home/(:any)']                = "home/$1";
$route['home/(:any)']  				     = "home/$1";

$route['^dk/user/(:any)']                = "user/$1";
$route['user/(:any)']                    = "user/$1";

$route['^dk/invitationer/(:any)']        = "invitationer/$1";
$route['invitationer/(:any)']            = "invitationer/$1";

$route['^dk/tilbud/(:any)']              = "tilbud/$1";
$route['tilbud/(:any)']                  = "tilbud/$1";

$route['^dk/payment/(:any)']             = "payment/$1";
